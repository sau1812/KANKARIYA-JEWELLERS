  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const productsQuery = `*[_type == "product" && category == "ring" && (gender == "men" || gender == "unisex")]{
          _id,
          title,
          originalPrice,
          "slug": slug.current,
    ...
    <div className="bg-stone-50 min-h-screen py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 border-b border-stone-200 pb-6 flex flex-col md:flex-row justify-between items-end gap-6">
           <div>
               <h1 className="text-3xl md:text-4xl font-serif text-stone-900 mb-2">Men's Ring</h1>
