  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // ✅ FIX: 'hoverImage' fetch line add ki hai aur image[0] ko "image" naam diya hai
    ...
    <div className="bg-stone-50 min-h-screen py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 border-b border-stone-200 pb-6 flex flex-col md:flex-row justify-between items-end gap-6">
           <div>
               <h1 className="text-3xl md:text-4xl font-serif text-stone-900 mb-2">Men's Chains</h1>
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
             ...
             <h3 className="text-xl font-medium text-stone-800 mb-2">No Matching Chains</h3>
             <p className="text-stone-500 max-w-md">Try adjusting your filters to explore our premium silver chains.</p>
          </div>
        )}
      </div>
    </div>
