      ...
      <div className="container mx-auto px-4">
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
             ...
             <h3 className="text-xl font-medium text-stone-800 mb-2">No Matching Silver Coins</h3>
             <p className="text-stone-500 max-w-md">Try adjusting your filters to explore our premium silver coins.</p>
          </div>
        )}
      </div>
    </div>
