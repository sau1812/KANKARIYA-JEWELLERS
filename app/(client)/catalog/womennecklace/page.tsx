...
export default function WomenNecklace() {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center font-serif italic text-stone-400">Loading Necklaces...</div>;
      ...
      <div className="container mx-auto px-4">
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
             ...
             <h3 className="text-xl font-medium text-stone-800 mb-2">No Matching Necklaces</h3>
             <p className="text-stone-500 max-w-md">Try changing your filters to see more from our necklace collection.</p>
          </div>
        )}
