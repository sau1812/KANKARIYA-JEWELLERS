  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const productsQuery = `*[_type == "product" && category == "bracelet" && isArchived != true]{
          _id,
          title,
          originalPrice,
          "slug": slug.current,
    ...
    <div className="bg-stone-50 min-h-screen py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 border-b border-stone-200 pb-6 flex flex-col md:flex-row justify-between items-end gap-6">
           <div>
               <h1 className="text-3xl md:text-4xl font-serif text-stone-900 mb-2">Silver Bracelets</h1>
               <p className="text-stone-500 text-sm md:text-base max-w-lg">Pure, hallmarked silver bracelets for gifting, investment, and auspicious occasions.</p>
           </div>
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
             ...
             <h3 className="text-xl font-medium text-stone-800 mb-2">No Matching Silver Bracelets</h3>
             <p className="text-stone-500 max-w-md">Try adjusting your filters to explore our premium silver bracelets.</p>
          </div>
        )}
      </div>
    </div>
