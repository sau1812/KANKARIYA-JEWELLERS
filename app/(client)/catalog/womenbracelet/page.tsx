...
export default function WomenBracelet() {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center font-serif italic text-stone-400">Loading Women's Collection...</div>;
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 border-b border-stone-200 pb-6 flex flex-col md:flex-row justify-between items-end gap-6">
           <div>
               ...
               <p className="text-stone-500 text-sm max-w-lg">Elegant, timeless, and crafted to enhance your style. Perfect for every occasion.</p>
           </div>
        ...
        <div className="flex flex-wrap gap-4 mb-10">
          ...
          {(priceRange !== 'All' || minRating !== 0) && (
            <button 
              ...
              className="text-rose-600 text-xs font-black uppercase tracking-widest hover:underline transition-all"
            >
              Reset Filters
            </button>
          )}
