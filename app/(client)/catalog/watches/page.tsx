  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const productsQuery = `*[_type == "product" && category == "watches" && (gender == "men" || gender == "unisex")]{
          _id,
          title,
          originalPrice,
          "slug": slug.current,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 border-b border-stone-200 pb-6 flex flex-col md:flex-row justify-between items-end gap-6">
           <div>
               ...
               <p className="text-stone-500 text-sm md:text-base max-w-lg">Strong, classic, and meticulously crafted pure silver watches for everyday wear.</p>
           </div>
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
             ...
             <h3 className="text-xl font-medium text-stone-800 mb-2">No Matching watches</h3>
             <p className="text-stone-500 max-w-md">Try adjusting your filters to explore our premium silver watches.</p>
          </div>
        )}
      </div>
    </div>
